...
export class EventControllerService {
  ...
  public createEvent(
    ...
    return this.httpClient.request<EventDto>(
      'post',
      `${this.basePath}/api/events/crud`,
      {
        body: body,
  ...
  public deleteEvent(
    ...
    return this.httpClient.request<any>(
      'delete',
      `${this.basePath}/api/events/crud/${encodeURIComponent(String(id))}`,
      {
        withCredentials: this.configuration.withCredentials,
        headers: headers,
        observe: observe,
  ...
  public getEventForUser(
    ...
    return this.httpClient.request<Array<EventDto>>(
      'get',
      `${this.basePath}/api/events/createdByUserOnly`,
      {
        withCredentials: this.configuration.withCredentials,
        headers: headers,
        observe: observe,
